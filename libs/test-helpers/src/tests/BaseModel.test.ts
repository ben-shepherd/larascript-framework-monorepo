...
import { BaseModel, BaseModelAttributes, IBaseModel } from "../test-helpers/BaseModel";
...
class TestModel extends BaseModel<TestModelAttributes> implements IBaseModel<TestModelAttributes> {
...
describe("BaseModel", () => {
    ...
    describe("integration tests", () => {
        ...
        test("should handle complete attribute replacement", () => {
            ...
            expect(testModel.getCreatedAt()).toEqual(new Date("2024-01-01T00:00:00Z"));
            expect(testModel.getUpdatedAt()).toEqual(new Date("2024-01-01T00:00:00Z"));
