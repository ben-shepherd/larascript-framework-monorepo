...
describe("BaseInMemoryRepository", () => {
    ...
    describe("update", () => {
        ...
        test("should update model attributes when where condition matches", async () => {
            ...
            const updatedRecord = (await repository.getRecords()).find(r => r.getAttributes().name === "John Doe");
        ...
        test("should update multiple records when where condition matches multiple records", async () => {
            ...
            const johnRecords = (await repository.getRecords()).filter(r => r.getAttributes().name === "John Doe");
        ...
        test("should not update any records when where condition does not match", async () => {
            const originalRecords = (await repository.getRecords()).map(r => ({ ...r.getAttributes() }));
        ...
        test("should update records when using email as where condition", async () => {
            ...
            const updatedRecord = (await repository.getRecords()).find(r => r.getAttributes().email === "jane@example.com");
            expect(updatedRecord).toBeDefined();
        ...
        test("should update records when using age as where condition", async () => {
            ...
            const updatedRecord = (await repository.getRecords()).find(r => r.getAttributes().age === 35);
            expect(updatedRecord).toBeDefined();
    ...
    describe("integration tests", () => {
        ...
        test("should maintain data integrity across operations", async () => {
            ...
            const johnRecord = (await repository.getRecords()).find(r => r.getAttributes().name === "John Doe");
            const janeRecord = (await repository.getRecords()).find(r => r.getAttributes().name === "Jane Smith");
