...
import { IAdapterComposerFileName, IDatabaseAdapter } from "../interfaces/adapter.t";
...
class DatabaseAdapter {
     ...
     */
    public static getComposerFileNames(db: IDatabaseService): IAdapterComposerFileName[] {
    ...
    public static getComposerShortFileNames(db: IDatabaseService): string[] {
        return this.getComposerFileNames(db)
            .map((composerFileName: IAdapterComposerFileName) => composerFileName.shortName);
    }
